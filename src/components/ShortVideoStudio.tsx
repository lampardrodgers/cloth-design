...
import { Clapperboard, Download, Megaphone, RefreshCw, Sparkles, Trash2, Upload, WandSparkles } from "lucide-react";
import {
      ...
      <div className="shortvideo-page">
        <header className="shortvideo-head">
          <div className="shortvideo-head-copy">
            ...
            <p className="muted-text">写文案 → 抽关键词 → 找素材 → 配音字幕 → 合成。仅 admin 可见，暂不扣积分。</p>
          </div>
            ...
            <div className="shortvideo-block">
              ...
              {safeForm.source === "local" ? (
                <div className="shortvideo-materials">
                  <div className="shortvideo-block-head">
                    <span className="field-label">本地素材（可多选，按点选顺序拼接）</span>
